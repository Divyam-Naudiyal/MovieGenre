...
train_path = r"C:\Users\lenovo\Downloads\archive\Genre Classification Dataset\train_data.txt"
...
def clean_text(text):
    ...
    text = ' '.join([stemmer.stem(word) for word in text.split() if
                     word not in stop_words])  # remove stopwords and stem other words
...
sns.barplot(x='Genre', y='length_Text_cleaning',
            data=train_data)  # from 600ish to 350ish -> significant reduction in length
